...
//    }
  ...
  $('#m_date').datepicker({
    ...
    $(".menu_btn").click(function(){
       $(".design_menu").toggleClass("rv9");
        $("body").toggleClass("rv10");
    });
    
    
$(".menu_img_rv").find(".carousel-item").first().addClass("active");
$(".clients_review_rv").find(".carousel-item").first().addClass("active");
